...
public enum ConfigKey
{
    ...
    BUY_GUI_PACKAGE_PRICE(new Configuration("buy-gui.package.price.normal", "<green>Price: </green><gold>%price%USD</gold>")),
    BUY_GUI_PACKAGE_PRICE_VIRTUAL(new Configuration("buy-gui.package.price.virtual", "<green>Price: </green><gold>%price%QQ</gold>")),
